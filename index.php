...
<body>
    ...
    <header class="header theme">
        <div class="layout-container">
            <div class="inner">
                ...
                <a target="_blank" href="https://attendee.gotowebinar.com/register/3940087147788519438"
                    class="btn btn dis-md">Register now</a>
    ...
    <main class="sitecontent">
        ...
        <!-- section banner -->
        <section class="section section-banner theme-green image-heroicon">
            <div class="layout-container">
                <div class="banner">
                    <div class="inner">
                        <div class="text">
                                ...
                                <div class="text-inner">
                                    ...
                                    <div class="text-events">
                                        ...
                                        <div class="time" data-aos="fade-in" data-aos-easing="linear"
                                            ...
                                            <h4 class="day">Wednesday 20th July 2022 </h4>
        ...
        <section id="speakers" class="section section-speakers theme-green">
            <div class="shapes">
            </div>
            <div class="barcode">
        ...
        <section class="section section-cta theme-green">
            <div class="layout-container">
                <div class="cta">
