...
<body>
                            ...
                            <defs>
                                <clipPath id="clip-path">
                                    <path id="Path_31" data-name="Path 31" d="M0,9.619H125.145V-21.36H0Z"
                                        transform="translate(0 21.36)" fill="none"></path>
                                </clipPath>
                                <clipPath id="clip-path-2">
                                    <path id="Path_37" data-name="Path 37"
                                        ...
                                        transform="translate(-68.804 19.4)" fill="none"></path>
                                </clipPath>
                                <linearGradient id="linear-gradient" x1="0.705" y1="0.683" x2="0.934" y2="0.683"
                                    gradientUnits="objectBoundingBox">
                                    <stop offset="0" stop-color="#ff3c27"></stop>
                                    <stop offset="0.1" stop-color="#ff4525"></stop>
                                    <stop offset="0.2" stop-color="#ff4f23"></stop>
                                    <stop offset="0.3" stop-color="#ff5821"></stop>
                                    <stop offset="0.4" stop-color="#ff611e"></stop>
                                    <stop offset="0.5" stop-color="#ff6e2d"></stop>
                                    <stop offset="0.6" stop-color="#ff7b3b"></stop>
                                    <stop offset="0.7" stop-color="#ff884b"></stop>
                                    <stop offset="0.8" stop-color="#ff955c"></stop>
                                    <stop offset="0.9" stop-color="#ffa26d"></stop>
                                    <stop offset="1" stop-color="#ffaf7f"></stop>
                                </linearGradient>
                            </defs>
                            <g id="Group_62" data-name="Group 62" transform="translate(0 0)">
                                <g id="logo-text" data-name="Group 31" transform="translate(0 0)"
                                    ...
                                    <g id="Group_29" data-name="Group 29" transform="translate(0 5.623)">
                                        <path id="Path_29" data-name="Path 29"
                                            ...
                                            transform="translate(41.49 9.014)" fill="#fff"></path>
                                    </g>
                                    <g id="Group_30" data-name="Group 30" transform="translate(61.849 0)">
                                        <path id="Path_30" data-name="Path 30"
                                            ...
                                            transform="translate(3.267)" fill="#fff"></path>
                                    </g>
                                </g>
                                <g id="logo-trademark" data-name="Group 32" transform="translate(65.745 22.809)">
                                    <path id="Path_32" data-name="Path 32"
                                        ...
                                        transform="translate(0 1.687)" fill="#fff"></path>
                                </g>
                                <path id="Path_33" data-name="Path 33" d="M44.057-5.3h1.629v-.329H44.057Z"
                                    transform="translate(19.84 28.443)" fill="#fff"></path>
                                ...
                                <path id="logo-line" data-name="Path 35" d="M58.292,9.513h.423V-21.124h-.423Z"
                                    transform="translate(26.251 21.466)" fill="#fff"></path>
                                ...
                                <g id="Group_45" data-name="Group 45" transform="translate(0 0)"
                                    ...
                                    <g id="Group_36" data-name="Group 36" transform="translate(122.625 15.478)">
                                        <path id="Path_38" data-name="Path 38"
                                            ...
                                            transform="translate(0.446)" fill="#fff"></path>
                                    </g>
    ...
    <main class="sitecontent">
        ...
        <!-- section banner -->
        <section class="section section-banner theme-red image-full">
            <div class="layout-container">
                <div class="banner">
                    <div class="inner">
                        <div class="text">
                        ...
                        <div class="media" data-aos="fade-left" data-aos-easing="linear" data-aos-delay="500"
                            ...
                            <img src="./images/studiolunchandlearn.png" alt="">
                        </div>
        ...
        <section id="speakers" class="section section-speakers theme-red">
            <div class="shapes">
            </div>
            <div class="barcode">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="name app-md">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="128.197"
                                                    height="781.393" viewBox="0 0 128.197 781.393">
                                                    <g id="Group_2394" data-name="Group 2394"
                                                        transform="translate(0 332.8)">
                                                        <g id="Group_2393" data-name="Group 2393"
                                                            transform="translate(0 -332.8)">
                                                            <g id="Group_2388" data-name="Group 2388"
                                                                transform="translate(0 657.422)">
                                                                <path id="Path_658" data-name="Path 658"
                                                                    d="M.2,71.171H32.78V67.825c-10.037,0-13.559-1.233-13.559-12.5V-28.5h.352L88.25,71.171h22.188v-109c0-4.578,1.233-11.622,11.622-11.622V-52.8H93.18v3.346c11.622,0,12.855,7.044,12.855,11.622V36.3h-.352L44.4-52.8H-.15v3.346H4.428l10.39,14.968V55.322c0,11.094-5.459,12.5-14.616,12.5Z"
                                                                    transform="translate(0.15 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2389" data-name="Group 2389"
                                                                transform="translate(0.352 493.066)">
                                                                <path id="Path_659" data-name="Path 659"
                                                                    d="M30.935,45.9h-28L16.5,5.4h.352ZM-22.95,89.921H3.816V86.575H1.351c-4.755,0-8.453-1.233-8.453-5.987A26.457,26.457,0,0,1-5.869,72.84l7.748-23.6H32.168L45.375,86.575H37.451v3.346H88.87V86.575H82.179L39.564-34.05H25.476L-10.976,75.305c-2.113,6.339-4.931,11.27-10.39,11.27H-22.95Z"
                                                                    transform="translate(22.95 34.05)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2390" data-name="Group 2390"
                                                                transform="translate(1.409 328.711)">
                                                                <path id="Path_660" data-name="Path 660"
                                                                    d="M0,71.171H97.909V34.015H94.563c0,17.257-11.8,33.81-39.269,33.81h-8.1V-49.454h11.27V-52.8H0v3.346H11.27V67.825H0Z"
                                                                    transform="translate(0 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2391" data-name="Group 2391"
                                                                transform="translate(1.409 164.355)">
                                                                <path id="Path_661" data-name="Path 661"
                                                                    d="M14.861,71.171H73.325V67.825H62.054V12L85.3-38.008c3.522-7.572,6.339-11.446,11.974-11.446h1.409V-52.8H70.155v3.346h2.113c4.755,0,8.453,1.409,8.453,6.163a32.037,32.037,0,0,1-2.641,11.622L60.294,6.72,33.879-49.454h7.572V-52.8H-11.025v3.346h6.516L26.131,15.877V67.825H14.861Z"
                                                                    transform="translate(11.025 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2392" data-name="Group 2392"
                                                                transform="translate(1.409 0)">
                                                                <path id="Path_662" data-name="Path 662"
                                                                    d="M27.093,1.921h7.044c29.936,0,34.515,23.068,34.515,58.816,0,25.886-1.409,58.464-35.571,58.464H27.093ZM-20.1,122.546H40.3c35.219,0,66.388-20.427,66.388-62.514,0-36.628-25.358-61.457-63.923-61.457H-20.1V1.921H-8.83V119.2H-20.1Z"
                                                                    transform="translate(20.1 1.425)" fill="#e78578" />
                                                            </g>
                                                        </g>
                                                    </g>
                                                </svg>
                                ...
                                <div class="layout-container">
                                    <div class="inner">
                                        <div class="media">
                                            ...
                                            <div class="name app-md">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="123.607"
                                                    height="781" viewBox="0 0 123.607 781">
                                                    <g id="Group_2403" data-name="Group 2403"
                                                        transform="translate(0 402.8)">
                                                        <g id="Group_2399" data-name="Group 2399"
                                                            transform="translate(0 -402.8)">
                                                            <g id="Group_2395" data-name="Group 2395"
                                                                transform="translate(21.377 678.625)">
                                                                <path id="Path_664" data-name="Path 664"
                                                                    d="M0,49.575H80.853V18.892H78.09c0,14.251-9.743,27.921-32.429,27.921H38.972V-50.037h9.307V-52.8H0v2.763H9.307V46.812H0Z"
                                                                    transform="translate(0 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2396" data-name="Group 2396"
                                                                transform="translate(17.305 542.9)">
                                                                <path id="Path_665" data-name="Path 665"
                                                                    d="M0,49.575H86.088V18.892H83.325c-2.763,16.432-8.871,27.921-33.592,27.921H38.972V-2.194H51.188c12.361,0,15.705,8.58,15.705,18.614h2.763v-39.7H66.893c0,10.034-3.635,18.323-15.124,18.323h-12.8v-45.08h12.8c21.813,0,27.048,10.906,28.357,23.7h2.763V-52.8H0v2.763H9.307V46.812H0Z"
                                                                    transform="translate(0 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2397" data-name="Group 2397"
                                                                transform="translate(13.306 407.175)">
                                                                <path id="Path_666" data-name="Path 666"
                                                                    d="M0,1.338H9.307V71.43c0,25.885,22.249,32.138,43.48,32.138,19.777,0,36.5-6.108,36.5-31.12V11.372c0-7.707,2.763-10.034,9.889-10.034V-1.425H74.891V1.338c5.671,0,10.761.582,10.761,10.325V71.576c0,19.922-10.616,26.612-25.158,26.612-10.47,0-21.522-6.253-21.522-22.249V1.338h9.307V-1.425H0Z"
                                                                    transform="translate(0 1.425)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2398" data-name="Group 2398"
                                                                transform="translate(11.269 268.832)">
                                                                <path id="Path_667" data-name="Path 667"
                                                                    d="M30.14,33.872h8.434v16c0,10.616-5.09,18.9-16.869,18.9C.474,68.773.183,45.651.183,19.912c0-33.3.291-53.224,23.7-53.224C45.845-33.312,53.843-8.3,53.843.571h2.763V-33.457H53.843c0,3.2-1.745,4.8-4.508,4.8-4.508,0-11.052-7.416-29.084-7.416-31.12,0-52.351,24.721-52.351,54.823,0,29.956,18.614,52.787,53.224,52.787,24.285,0,37.227-10.47,44.5-14.978V33.872h7.562V31.109H30.14Z"
                                                                    transform="translate(32.1 36.075)" fill="#e78578" />
                                                            </g>
                                                        </g>
                                                        <g id="Group_2400" data-name="Group 2400"
                                                            transform="translate(38.464 -267.075)">
                                                            <path id="Path_669" data-name="Path 669"
                                                                d="M0,49.575H48.279V46.812H38.972V-50.037h9.307V-52.8H0v2.763H9.307V46.812H0Z"
                                                                transform="translate(0 52.8)" fill="#e78578" />
                                                        </g>
                                                        <g id="Group_2402" data-name="Group 2402"
                                                            ...
                                                            <g id="Group_2401" data-name="Group 2401"
                                                                ...
                                                                <path id="Path_670" data-name="Path 670"
                                                                    d="M0,49.575H23.413V46.812c-6.835,0-9.889-1.89-9.889-9.161V-43.2h.291L46.389,49.575h5.962L85.216-44.366h.291V46.812H76.2v2.763h47.407V46.812H114.3V-50.037h9.307V-52.8H84.78l-22.1,63.112h-.291L39.845-52.8H.582v2.763H9.889V37.651c0,7.271-3.054,9.161-9.889,9.161Z"
                                                                    transform="translate(0 52.8)" fill="#e78578" />
                                                            </g>
                                                        </g>
                                                    </g>
                                                    ...
                                                    <g id="Group_2412" data-name="Group 2412"
                                                        ...
                                                        <g id="Group_2406" data-name="Group 2406"
                                                            ...
                                                            <g id="Group_2404" data-name="Group 2404"
                                                                transform="translate(2.91 678.625)">
                                                                <path id="Path_672" data-name="Path 672"
                                                                    d="M.141,49.575h26.9V46.812c-8.289,0-11.2-1.018-11.2-10.325v-69.22h.291L72.851,49.575H91.173V-40.439c0-3.781,1.018-9.6,9.6-9.6V-52.8H76.922v2.763c9.6,0,10.616,5.817,10.616,9.6V20.782h-.291L36.641-52.8H-.15v2.763H3.631l8.58,12.361V36.488c0,9.161-4.508,10.325-12.07,10.325Z"
                                                                    transform="translate(0.15 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2405" data-name="Group 2405"
                                                                transform="translate(7.199 542.9)">
                                                                <path id="Path_673" data-name="Path 673"
                                                                    d="M21.548,31.97H-1.573L9.624-1.476h.291Zm-44.5,36.355h22.1V65.562H-2.882c-3.926,0-6.98-1.018-6.98-4.944a21.848,21.848,0,0,1,1.018-6.4l6.4-19.486H22.566L33.473,65.562H26.929v2.763H69.391V65.562H63.865L28.674-34.05H17.04l-30.1,90.306c-1.745,5.235-4.072,9.307-8.58,9.307H-22.95Z"
                                                                    transform="translate(22.95 34.05)" fill="#e78578" />
                                                            </g>
                                                        </g>
                                                        <g id="Group_2407" data-name="Group 2407"
                                                            ...
                                                            <path id="Path_675" data-name="Path 675"
                                                                d="M28.309,0V2.763h9.307V47.841H8.822V2.763h9.307V0H-30.15V2.763h9.307V99.612H-30.15v2.761H18.129V99.612H8.822V50.606H37.616V99.612H28.309v2.761H76.588V99.612H67.281V2.763h9.307V0Z"
                                                                transform="translate(30.15)" fill="#e78578" />
                                                        </g>
                                                        <g id="Group_2411" data-name="Group 2411"
                                                            transform="translate(0 -402.8)">
                                                            <g id="Group_2408" data-name="Group 2408"
                                                                transform="translate(8.145 271.45)">
                                                                <path id="Path_676" data-name="Path 676"
                                                                    d="M10.211,49.575H58.49V46.812H49.183V-50.037c23.413,0,27.63,21.231,27.63,28.793h2.763V-52.8H-10.875v31.556h2.763c0-7.562,4.217-28.793,27.63-28.793V46.812H10.211Z"
                                                                    transform="translate(10.875 52.8)" fill="#e78578" />
                                                            </g>
                                                            <g id="Group_2409" data-name="Group 2409"
                                                                transform="translate(7.199 135.725)">
        ...
        <section id="events" class="section section-upcoming-events theme-red">
            <div class="layout-container">
        ...
        <section class="section section-cta theme-red">
            <div class="layout-container">
                <div class="cta">
        ...
        <section class="section section-imggrid">
            <div class="container">
                <div class="imggrid">
                    <div class="imggrid-row">
                        <div class="item">
                            <img src="./images/imggrid-1.png" alt="">
                        </div>
                        <div class="item">
                            <img src="./images/imggrid-2.png" alt="">
                        </div>
                        <div class="item">
                            <img src="./images/imggrid-3.png" alt="">
                        </div>
                        <div class="item">
                            <img src="./images/imggrid-4.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
